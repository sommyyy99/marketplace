      ...
      <header className="relative z-20 bg-[#FFF8E7] px-6 py-4">
        ...
        <div className="max-w-[1200px] mx-auto mt-8 relative h-[240px] overflow-hidden">
          ...
          <div className="absolute bottom-[16px]" style={{ animation: 'bikeRight 16s linear infinite', animationDelay: '5s' }}>
            <svg width="190" height="110" viewBox="0 0 200 110" fill="none" xmlns="http://www.w3.org/2000/svg">
              {/* Delivery box on rear */}
              <rect x="110" y="18" width="44" height="34" rx="4" fill="#FF8FA3" />
              <rect x="110" y="18" width="44" height="8" rx="3" fill="#D6336C" />
              <text x="132" y="40" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">EATS</text>
              {/* Rider helmet */}
              <circle cx="82" cy="12" r="10" fill="#1B5E3E" />
              <ellipse cx="80" cy="14" rx="7" ry="5" fill="#144d32" />
              {/* Rider body */}
              <rect x="76" y="22" width="16" height="18" rx="4" fill="#144d32" />
              {/* Rider arms */}
              <line x1="76" y1="28" x2="54" y2="32" stroke="#144d32" strokeWidth="4" strokeLinecap="round" />
              {/* Front cowl */}
              <path d="M38 52 Q30 44 32 36 L52 30 L62 52 Z" fill="#2A9D8F" />
              {/* Headlight */}
              <ellipse cx="34" cy="44" rx="6" ry="5" fill="#FFF8E7" stroke="#e0d0a0" strokeWidth="1" />
              {/* Main tank */}
              <path d="M58 28 Q90 22 108 30 L112 50 L58 52 Z" fill="#2A9D8F" />
              {/* Engine block */}
              <rect x="64" y="50" width="44" height="20" rx="3" fill="#667085" />
              <rect x="70" y="54" width="12" height="12" rx="2" fill="#4b5563" />
              <rect x="90" y="54" width="12" height="12" rx="2" fill="#4b5563" />
